...
export const projectsService = {
  ...
  list: async (page = 0, resultsPerPage = 10, sort, query = '', lineOfResearchId = '', year = '', onGoing = '') => {
    const url = routes.projects.list(page, resultsPerPage, sort, query, lineOfResearchId, year, onGoing);
