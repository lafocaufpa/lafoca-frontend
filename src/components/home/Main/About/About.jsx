    ...
    <section className={styles.about_lafoca}>
      ...
      <div className={`${styles.appointments}`}>
        ...
        <div className={styles.container__accordion}>
          <h2> Compromissos que <br/> <span>desenvolvemos</span></h2>
          <p className='global__paragraph_text'>Conheça os princípios que norteiam as atividades do laboratório e garantem a excelência nos projetos e resultados obtidos.
          </p>
